...
function Movie() {
 ...
 const url =
    "https://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&api_key=4621eb930eceb8d23839805cd87e953a&page="+count;
...
setCount(count+1);
  ...
  return (<Container>
    ...
    <Controls>
    <h1  onClick={handleDecreasePage} className={disable ?'change-page-btn active': 'change-page-btn'}>Prev</h1>
