    ...
    <Container>
        ...
        <> 
            ...
            <Show className={open ? 'movie':'active'}>
                <iframe data-src='https://2embed.org/embed/movie?imdb=tt5113044' class="ve-iframe lazy entered loaded" id="ve-iframe" allowfullscreen="allowfullscreen" frameborder="0" data-ll-status="loaded" src={"https://2embed.org/embed/movie?tmdb="+movie.id}></iframe>
