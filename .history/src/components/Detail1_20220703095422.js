  ...
  return (
    <Container>
        ...
        <> 
           ...
           {video&& <iframe className='ve-iframe' src={"https://www.youtube.com/embed/"+video.results[0].key} title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>} 
